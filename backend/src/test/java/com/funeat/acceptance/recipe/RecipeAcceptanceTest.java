...
public class RecipeAcceptanceTest extends AcceptanceTest {
    ...
    class writeRecipe_성공_테스트 {
        ...
        void 레시피를_작성한다() {
            ...
            // when
            final var response = 레시피_작성_요청(로그인_쿠키를_얻는다(1L), List.of(사진_명세_요청("1")), 레시피추가요청_생성(List.of(1L)));
        ...
        void 이미지가_없어도_레시피를_작성할_수_있다() {
            ...
            // when
            final var response = 레시피_작성_요청(로그인_쿠키를_얻는다(1L), null, 레시피추가요청_생성(List.of(1L)));
    ...
    class writeRecipe_실패_테스트 {
        ...
        void 로그인_하지않은_사용자가_레시피_작성시_예외가_발생한다(final String cookie) {
            ...
            // when
            final var response = 레시피_작성_요청(cookie, List.of(사진_명세_요청("1")), 레시피추가요청_생성(List.of(1L)));
        ...
        void 사용자가_레시피_작성할때_레시피이름_미기입시_예외가_발생한다(final String title) {
            ...
            // when
            final var response = 레시피_작성_요청(로그인_쿠키를_얻는다(1L), List.of(사진_명세_요청("1")), request);
    ...
    class getRecipeDetail_성공_테스트 {
        ...
        void 레시피의_상세_정보를_조회한다() {
            ...
            레시피_작성_요청(로그인_쿠키를_얻는다(1L), List.of(사진_명세_요청("1")), 레시피추가요청_생성(List.of(1L, 2L)));

            // when
            final var response = 레시피_상세_정보_요청(로그인_쿠키를_얻는다(1L), 1L);
    ...
    class getRecipeDetail_실패_테스트 {
        ...
        void 존재하지_않는_레시피_사용자가_레시피_상세_조회시_예외가_발생한다() {
            // given && when
            final var response = 레시피_상세_정보_요청(로그인_쿠키를_얻는다(1L), 999L);
    ...
    class likeRecipe_성공_테스트 {
        ...
        void 레시피에_좋아요를_할_수_있다() {
            ...
            // when
            final var response = 레시피_좋아요_요청(로그인_쿠키를_얻는다(1L), 1L, 레시피좋아요요청_생성(true));
        ...
        void 레시피에_좋아요를_취소할_수_있다() {
            ...
            // when
            final var response = 레시피_좋아요_요청(로그인_쿠키를_얻는다(1L), 1L, 레시피좋아요요청_생성(false));
    ...
    class likeRecipe_실패_테스트 {
        ...
        void 사용자가_레시피에_좋아요를_할때_좋아요_미기입시_예외가_발생한다() {
            ...
            // when
            final var response = 레시피_좋아요_요청(로그인_쿠키를_얻는다(1L), 1L, 레시피좋아요요청_생성(null));
        ...
        void 존재하지_않는_레시피에_사용자가_좋아요를_할때_예외가_발생한다() {
            // given && when
            final var response = 레시피_좋아요_요청(로그인_쿠키를_얻는다(1L), 999L, 레시피좋아요요청_생성(true));
    ...
    class getSearchResults_성공_테스트 {
        ...
        void 검색어에_해당하는_상품이_포함된_레시피가_2개면_레시피_2개를_반환한다() {
            ...
            레시피_작성_요청(로그인_쿠키를_얻는다(1L), List.of(사진_명세_요청("1")), 레시피추가요청_생성(List.of(1L)));
            레시피_작성_요청(로그인_쿠키를_얻는다(1L), List.of(사진_명세_요청("2")), 레시피추가요청_생성(List.of(1L, 2L)));
            레시피_작성_요청(로그인_쿠키를_얻는다(1L), List.of(사진_명세_요청("3")), 레시피추가요청_생성(List.of(2L)));
    ...
    class getSortingRecipes_성공_테스트 {
        ...
        void 꿀조합을_좋아요가_많은_순으로_정렬할_수_있다() {
            ...
            레시피_작성_요청(로그인_쿠키를_얻는다(1L), List.of(사진_명세_요청("3")), 레시피추가요청_생성(List.of(1L)));
            레시피_좋아요_요청(로그인_쿠키를_얻는다(1L), 1L, 레시피좋아요요청_생성(true));
            레시피_좋아요_요청(로그인_쿠키를_얻는다(1L), 2L, 레시피좋아요요청_생성(true));
            레시피_좋아요_요청(로그인_쿠키를_얻는다(2L), 2L, 레시피좋아요요청_생성(true));

            final var pageDto = new PageDto(3L, 1L, true, true, FIRST_PAGE, PAGE_SIZE);

            // when
            final var response = 레시피_목록_요청("favoriteCount,desc", FIRST_PAGE);
        ...
        void 꿀조합을_최신순으로_정렬할_수_있다() {
            ...
            // when
            final var response = 레시피_목록_요청("createdAt,desc", FIRST_PAGE);
        ...
        void 꿀조합을_오래된순으로_정렬할_수_있다() {
            ...
            // when
            final var response = 레시피_목록_요청("createdAt,asc", FIRST_PAGE);
    ...
    class getRankingRecipes_성공_테스트 {
        ...
        void 전체_꿀조합들_중에서_랭킹_TOP3를_조회할_수_있다() {
            ...
            레시피_작성_요청(로그인_쿠키를_얻는다(1L), List.of(사진_명세_요청("2")), 레시피추가요청_생성(List.of(1L)));
            레시피_작성_요청(로그인_쿠키를_얻는다(1L), List.of(사진_명세_요청("3")), 레시피추가요청_생성(List.of(1L)));
            레시피_작성_요청(로그인_쿠키를_얻는다(1L), List.of(사진_명세_요청("4")), 레시피추가요청_생성(List.of(1L)));
            레시피_좋아요_요청(로그인_쿠키를_얻는다(1L), 2L, 레시피좋아요요청_생성(true));
            레시피_좋아요_요청(로그인_쿠키를_얻는다(2L), 2L, 레시피좋아요요청_생성(true));
            레시피_좋아요_요청(로그인_쿠키를_얻는다(1L), 3L, 레시피좋아요요청_생성(true));
            레시피_좋아요_요청(로그인_쿠키를_얻는다(1L), 4L, 레시피좋아요요청_생성(true));
            레시피_좋아요_요청(로그인_쿠키를_얻는다(2L), 4L, 레시피좋아요요청_생성(true));
            레시피_좋아요_요청(로그인_쿠키를_얻는다(3L), 4L, 레시피좋아요요청_생성(true));
