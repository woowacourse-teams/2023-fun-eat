...
import static com.funeat.fixture.ProductFixture.상품_삼각김밥_가격2000원_평점_3점_생성;
...
import static com.funeat.fixture.ProductFixture.상품_삼각김밥_가격3000원_평점_3점_생성;
import static com.funeat.fixture.ProductFixture.상품_삼각김밥_가격3000원_평점_4점_생성;
import static com.funeat.fixture.ProductFixture.상품_삼각김밥_가격4000원_평점_2점_생성;
import static com.funeat.fixture.ProductFixture.상품_삼각김밥_가격4000원_평점_4점_생성;
import static com.funeat.fixture.ProductFixture.상품_삼각김밥_가격5000원_평점_1점_생성;
import static com.funeat.fixture.ProductFixture.상품_삼각김밥_가격5000원_평점_3점_생성;
import static com.funeat.fixture.ProductFixture.상품_삼각김밥_가격5000원_평점_4점_생성;
...
class ProductAcceptanceTest extends AcceptanceTest {
    ...
    @Nested
    class getAllProductsInCategory_테스트 {
        ...
        class 성공_테스트 {
            ...
            class 가격_기준_내림차순으로_카테고리별_상품_목록_조회 {
                ...
                void 상품_가격이_서로_다르면_가격_기준_내림차순으로_정렬할_수_있다() {
                    ...
                    final var product1 = 상품_삼각김밥_가격1000원_평점_5점_생성(category);
                    final var product2 = 상품_삼각김밥_가격2000원_평점_3점_생성(category);
                    final var product3 = 상품_삼각김밥_가격2000원_평점_1점_생성(category);
                    final var product4 = 상품_삼각김밥_가격4000원_평점_4점_생성(category);
                    final var product5 = 상품_삼각김밥_가격5000원_평점_4점_생성(category);
                    final var product6 = 상품_삼각김밥_가격1000원_평점_2점_생성(category);
                    final var product7 = 상품_삼각김밥_가격4000원_평점_2점_생성(category);
                    final var product8 = 상품_삼각김밥_가격5000원_평점_1점_생성(category);
                    final var product9 = 상품_삼각김밥_가격3000원_평점_3점_생성(category);
                    final var product10 = 상품_삼각김밥_가격3000원_평점_1점_생성(category);
                    final var product11 = 상품_삼각김밥_가격1000원_평점_1점_생성(category);
                ...
                void 상품_가격이_서로_같으면_ID_기준_내림차순으로_정렬할_수_있다() {
                    ...
                    final var product1 = 상품_삼각김밥_가격1000원_평점_5점_생성(category);
                    final var product2 = 상품_삼각김밥_가격1000원_평점_3점_생성(category);
                    final var product3 = 상품_삼각김밥_가격1000원_평점_1점_생성(category);
                    final var product4 = 상품_삼각김밥_가격1000원_평점_4점_생성(category);
                    final var product5 = 상품_삼각김밥_가격1000원_평점_4점_생성(category);
                    final var product6 = 상품_삼각김밥_가격1000원_평점_2점_생성(category);
                    final var product7 = 상품_삼각김밥_가격1000원_평점_2점_생성(category);
                    final var product8 = 상품_삼각김밥_가격1000원_평점_1점_생성(category);
                    final var product9 = 상품_삼각김밥_가격1000원_평점_3점_생성(category);
                    final var product10 = 상품_삼각김밥_가격1000원_평점_1점_생성(category);
                    final var product11 = 상품_삼각김밥_가격1000원_평점_1점_생성(category);
                    final var products = List.of(product1, product2, product3, product4, product5, product6, product7,
                            product8, product9, product10, product11);
                    복수_상품_저장(products);
            ...
            class 평점_기준_내림차순으로_카테고리별_상품_목록_조회 {
                ...
                void 상품_평점이_서로_다르면_평점_기준_내림차순으로_정렬할_수_있다() {
                    ...
                    final var product3 = 상품_삼각김밥_가격2000원_평점_1점_생성(category);
                    final var product4 = 상품_삼각김밥_가격1000원_평점_4점_생성(category);
                    final var product5 = 상품_삼각김밥_가격2000원_평점_4점_생성(category);
                    final var product6 = 상품_삼각김밥_가격1000원_평점_2점_생성(category);
                    final var product7 = 상품_삼각김밥_가격1000원_평점_2점_생성(category);
                    final var product8 = 상품_삼각김밥_가격1000원_평점_1점_생성(category);
                    final var product9 = 상품_삼각김밥_가격3000원_평점_3점_생성(category);
                    final var product10 = 상품_삼각김밥_가격2000원_평점_1점_생성(category);
                    final var product11 = 상품_삼각김밥_가격1000원_평점_1점_생성(category);
                    final var products = List.of(product1, product2, product3, product4, product5, product6, product7,
                            product8, product9, product10, product11);
                    복수_상품_저장(products);
                ...
                void 상품_평점이_서로_같으면_ID_기준_내림차순으로_정렬할_수_있다() {
                    ...
                    final var product3 = 상품_삼각김밥_가격2000원_평점_1점_생성(category);
                    final var product4 = 상품_삼각김밥_가격1000원_평점_1점_생성(category);
                    final var product5 = 상품_삼각김밥_가격2000원_평점_1점_생성(category);
                    final var product6 = 상품_삼각김밥_가격1000원_평점_1점_생성(category);
                    final var product7 = 상품_삼각김밥_가격1000원_평점_1점_생성(category);
                    final var product8 = 상품_삼각김밥_가격1000원_평점_1점_생성(category);
                    final var product9 = 상품_삼각김밥_가격3000원_평점_1점_생성(category);
                    final var product10 = 상품_삼각김밥_가격2000원_평점_1점_생성(category);
                    final var product11 = 상품_삼각김밥_가격1000원_평점_1점_생성(category);
                    final var products = List.of(product1, product2, product3, product4, product5, product6, product7,
                            product8, product9, product10, product11);
            ...
            class 리뷰수_기준_내림차순으로_카테고리별_상품_목록_조회 {
                ...
                void 리뷰수가_서로_다르면_리뷰수_기준_내림차순으로_정렬할_수_있다() {
                    ...
                    final var reviews = List.of(review1_1, review1_2, review1_3, review2_1, review2_2, review3_1,
                            review3_2, review3_3);
                    복수_리뷰_저장(reviews);
                ...
                void 리뷰수가_서로_같으면_ID_기준_내림차순으로_정렬할_수_있다() {
                    ...
                    final var product1 = 상품_삼각김밥_가격1000원_평점_5점_생성(category);
                    final var product2 = 상품_삼각김밥_가격5000원_평점_3점_생성(category);
                    final var product3 = 상품_삼각김밥_가격3000원_평점_1점_생성(category);
                    final var product4 = 상품_삼각김밥_가격2000원_평점_4점_생성(category);
                    final var product5 = 상품_삼각김밥_가격3000원_평점_4점_생성(category);
                    ...
                    final var review2_1 = 리뷰_이미지test1_평점1점_재구매X_생성(member1, product2, 0L);
                    final var review3_1 = 리뷰_이미지test2_평점2점_재구매X_생성(member1, product3, 0L);
                    final var reviews = List.of(review1_1, review2_1, review3_1);
                    복수_리뷰_저장(reviews);
    ...
    class getProductDetail_테스트 {
        ...
        class 성공_테스트 {
            ...
            void 상품_상세_정보를_조회한다() {
                ...
                final var tags = List.of(tag1, tag2, tag3);
                복수_태그_저장(tags);
    ...
    class getRankingProducts_테스트 {
        ...
        class 성공_테스트 {
            ...
            void 전체_상품들_중에서_랭킹_TOP3를_조회할_수_있다() {
                ...
                final var product2 = 상품_삼각김밥_가격1000원_평점_5점_생성(category);
                final var product3 = 상품_삼각김밥_가격1000원_평점_4점_생성(category);
                final var product4 = 상품_삼각김밥_가격1000원_평점_1점_생성(category);
