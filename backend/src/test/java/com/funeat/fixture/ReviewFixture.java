...
public class ReviewFixture {
    ...
    public static Review 리뷰_이미지없음_평점5점_재구매X_생성(final Member member, final Product product, final Long count) {
        return new Review(member, product, null, 5L, "test", false, count);
    }
