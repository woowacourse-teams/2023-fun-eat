...
class ReviewRepositoryTest extends RepositoryTest {
    ...
    class countByProduct_테스트 {
        ...
        class 성공_테스트 {
            ...
            void 상품의_리뷰_수를_반환한다() {
                ...
                final var reviews = List.of(review1_1, review1_2, review1_3, review2_1);
                복수_리뷰_저장(reviews);
    ...
    @Nested
    class findReviewsByProduct_테스트 {
    ...
    @Nested
    class findTop3ByOrderByFavoriteCountDesc_테스트 {
        ...
        class 성공_테스트 {
            ...
            void 전체_리뷰_목록에서_가장_좋아요가_높은_상위_3개의_리뷰를_가져온다() {
                ...
                final var reviews = List.of(review1_1, review1_2, review1_3, review2_2, review3_2);
                복수_리뷰_저장(reviews);
