        ...
        class 성공_테스트 {
            ...
            void 리뷰에_좋아요를_할_수_있다() {
                ...
                assertSoftly(softAssertions -> {
                    softAssertions.assertThat(actualReview.getFavoriteCount()).isOne();
                    softAssertions.assertThat(actualReviewFavorite.getFavorite()).isTrue();
                });
            }
            ...
            void 리뷰에_좋아요를_취소_할_수_있다() {
                ...
                // then
                assertSoftly(softAssertions -> {
                    softAssertions.assertThat(actualReview.getFavoriteCount()).isZero();
                    softAssertions.assertThat(actualReviewFavorite.getFavorite()).isFalse();
                });
            }
        }
