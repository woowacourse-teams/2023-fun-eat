...
import mockReviewList from '../data/reviews.json';
...
export const rankingHandlers = [
  ...
  rest.get('/api/ranks/products/:productId/reviews', (req, res, ctx) => {
    return res(ctx.status(200), ctx.json(mockReviewList.reviews[2]));
  }),
];
